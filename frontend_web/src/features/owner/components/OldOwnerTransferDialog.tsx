...
interface OldOwnerTransferDialogProps {
  ...
  // IDs of owners that the parent has selected to move out
  selectedOwnersMovingOut?: string[];
  // Callback invoked when initiating the transfer. Provided by parent.
  onInitiateTransfer?: (
    propertyId: string,
